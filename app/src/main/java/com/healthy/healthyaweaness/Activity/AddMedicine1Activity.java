...
public class AddMedicine1Activity extends BaseActivity implements DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
...
//                    date = mUserToDoItem.getToDoDate();
                ...
                DatePickerDialog datePickerDialog = DatePickerDialog.newInstance(AddMedicine1Activity.this, year, month, day);
                if (theme.equals(MainActivity.DARKTHEME)) {
...
//                    date = mUserToDoItem.getToDoDate();
                ...
                TimePickerDialog timePickerDialog = TimePickerDialog.newInstance(AddMedicine1Activity.this, hour, minute, DateFormat.is24HourFormat(AddMedicine1Activity.this));
                if (theme.equals(MainActivity.DARKTHEME)) {
