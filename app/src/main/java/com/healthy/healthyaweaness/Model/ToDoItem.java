...
public class ToDoItem implements Serializable{
    ...
    private static final String ALETER_ID = "ALETER_ID";
    private static final String MEDCICNE_DES = "MEDCICNE_DES";
    ...
    public ToDoItem(JSONObject jsonObject) throws JSONException{
        ...
        Medcibe_desc=jsonObject.getString(MEDCICNE_DES);
        mALETER_ID=jsonObject.getString(ALETER_ID);
